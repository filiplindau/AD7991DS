''' Copied from python-periphery: periphery.i2c

Modified by Filip Lindau
16-04-06
...
if __name__ == '__main__':
    i2c = I2C('/dev/i2c-1')
    dw = [np.uint8(0b00011000)]
    dr = bytearray(2)
#    msg = [I2C.Message(dw), I2C.Message(dr, read=True)]
    msg = [I2C.Message(dr, read=True)]
    i2c.transfer(0x28, msg)
    i2c.close()
